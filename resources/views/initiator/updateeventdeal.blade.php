        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            ...
            <li class="nav-parent active">
             ...
             <ul class="children">
                <li class="active"><a  href="{{ URL::to('initiator/updateeventdeal')}}"><i class="fa fa-pencil-square-o"></i><span> Update New Deal</span></a></li>
      ...
      <div class="row">
          ...
          <ul class="nav nav-tabs nav-primary">
            <li class="active"><a href="#popular5" data-toggle="tab"><strong>Update new deal</strong></a></li>
             ...
             <li><a href="#comments5" data-toggle="tab"><strong>Deal Cancelled <span style="color:red">( <?php echo count($dealcan) ?> )</span>   </strong></a></li>
