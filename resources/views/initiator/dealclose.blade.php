             ...
             <table  id="dataTable1" class="table table-bordered table-striped-col">
                                                                ...
                                                                <tbody>
                                                                 ...
                                                                 <td>
                                                                  ...
                                                                  <a class="btn btn-primary employee btn-block" data-toggle="modal"  data-target="#myModal" id="action_<?php echo $lead->id ?>">Proceed to Deal Close</a>
...
$('.employee').click(function(e) {
   ...
   var actoinid , nId,name,employe_id,department,empid,leadcode;
  ...
  leadcode = $(this).closest("tr").find('td:eq(0)').text();
     ...
     <div class="modal bounceIn animated" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h3>Please confirm the below</h3>
    ...
    @endforeach
                        ...
                        <div class="modal-body">
                             ...
                             <table width="100%"  class="table">
                              ...
                              <tr>
                                ...
                                <td>  Contract Sent Date</td><td>   <input type="text" class="form-control condate " autocomplete="off" name="sent_date"></td>

                            

                                 <td>  Contract Received Date</td><td>     <input type="text" class="form-control condate "  autocomplete="off" name="rec_date"></td>
                      ...
                      ?>
                       ...
                       <form action="{{ url('/initiator/delegatedealclose') }}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                           ...
                           <td>   <input type="radio"  autocomplete="off" name="boq" value="1">&nbsp; Accepted&nbsp;</td>

                              <td> <input type="radio"  autocomplete="off" name="boq" value="0"> &nbsp;Rejected&nbsp;</td>
