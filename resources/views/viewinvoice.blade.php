...
<table  style="width: 750px; height:50px;border: solid 0.5px #ccc; background: #E7E7E7; margin-left:20px; margin-top:10px;  font-size: 12px;">
        <tr style="">
    ...
    <table  style="width: 750px;  height:50px; border: solid 0.5px #ccc; margin-left:20px;  font-size: 12px;">
        <tr>
            ...
            <td style="width: 15%;text-align:right;">Sub Total [a] : </td>
  ...
  <table  style="width: 750px;   height:50px; border: solid 0.5px #ccc;margin-left:20px;  font-size: 12px;">
        ...
        <tr>
            <td style="width:10%;"></td>
            <td style="width:15%;"></td>
            <td style="width:60%;text-align:right;">  Swachh Bharat Cess @ @ {{$inv->swachtax}}% </td>
            <td style="width:15%;text-align:right;">{{$inv->swachtaxamount}}</td>
        </tr>
         <tr>
            <td style="width: 10%;"></td>
            <td style="width: 60%; "></td>
            <td style="width: 15%;text-align:right;">Sub Total [b] : </td>
            <td style="width: 15%;text-align:right;">{{$inv->subtotalb}}</td>
        </tr>
    </table>
    @endif
    ...
    <table  style="width:750px;  height:50px; border: solid 0.5px #ccc;  margin-top:10px;margin-left:20px;font-size: 12px;">
        <tr>
          <td style="width:100%;">
             <b>Amount in Words</b> :   {{$inv->AmountInWords}} {{$inv->CurrencyType}} Only
          </td>
        </tr>
    </table>
    ...
    <table style="width:750px;  height:150px;border: solid 0.5px #ccc;margin-left:20px;font-size: 12px; margin-top:10px;">
        <tr>
...
<page backcolor="#FEFEFE" backimg="" backimgx="center" backimgy="bottom" backimgw="100%" backtop="0" backbottom="30mm" footer="date;heure;page" style="font-size: 12pt">
   <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
    <table cellspacing="0" style="width: 100%; margin-left:15px;text-align: center; font-size: 14px;margin-top:10px">
        <tr>
            <td style="width: 20%;">
                 <img style="width: 100%;" src="{{asset('/img/ide_color_logo.jpg')}}" alt="Logo">
            </td>
 ...
 @if($inv->CurrencyType=='INR')
  <table  style="width: 750px;   height:80px; border: solid 0.5px #ccc; margin-left:20px;  font-size: 12px;">
    ...
    <table style="width: 750px;   height:80px; border: solid 0.5px #ccc; margin-left:20px;  margin-top:10px; font-size: 12px;">
        <tr>
          <td style="width: 100%;">
             <b>Amount in Words </b>: {{$inv->AmountInWords}} {{$inv->CurrencyType}} Only
          </td>
    ...
    <table style="width:750px;  height:150px;border: solid 0.5px #ccc;margin-left:20px; margin-top:10px;font-size: 12px;">
        <tr>
          <td style="width: 50%;">
            <b><u>Bank Details</u></b><br><br>
              <b>Beneficiary </b>: IDE Consulting Services Pvt Ltd<br>
