            ...
            <li class="nav-parent ">
             ...
             <ul class="children">
                <li ><a href="{{ URL::to('initiator/leadsheet')}}"><i class="fa fa-line-chart"></i><span> Lead Sheet</span></a></li>
                  <li class="active"><a href="{{ URL::to('initiator/pendingforfollowup')}}"><i class="fa fa-line-chart"></i><span> Pending for Follow up</span></a></li>
    ...
    @endforeach
      ...
      <div class="row">
          ...
          <ul class="nav nav-tabs nav-primary">
            ...
            <li class="active"><a href="#recent5" data-toggle="tab"><strong>Pending for  follow up <span style="color:red">( <?php echo count($lead_id) ?> )</span></strong></a></li>
