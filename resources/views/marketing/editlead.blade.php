        ...
        <div class="tab-pane active" id="mainmenu">
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            ...
            <li class="nav-parent ">
             ...
             <ul class="children">
                <li><a  href="{{ URL::to('marketing/mycancellation')}}"><i class="fa fa-pencil-square-o"></i><span> My Cancellation</span></a></li>
                  <li><a  href="{{ URL::to('marketing/deals')}}"><i class="fa fa-pencil-square-o"></i><span> My Deals</span></a></li>
      ...
      <div class="row">
          ...
          <div class="tab-content mb20">
            <div class="tab-pane active" id="popular5">
                <form action="{{ url('/marketing/updateleadsheet') }}" method="post"  enctype="multipart/form-data" class="form-horizontal">
