    ...
    <div class="panel-body">
     <!--  <button class="btn btn-primary btn-quirk btn-fb btn-block">Connect with Facebook</button>
      ...
      <form method="POST" action="{{ action('LoginController@postLogin') }}">
        ...
        <div class="form-group mb10">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
             <input type="text" class="form-control" name="empid" autocomplete="off" placeholder="Enter your emp id">
          </div>
        </div>
	   ...
	   <!-- <div class="form-group">
			<input type="hidden" id="url" value="{{ action('LoginController@postLogin') }}">
